    ...
    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <linearGradient id="paint5_linear" x1="22" y1="0" x2="22" y2="44" gradientUnits="userSpaceOnUse">
                <stop offset="50%" stopColor="#f5ae16"></stop>
                <stop offset="100%" stopColor="#d99009"></stop>
            </linearGradient>
        </defs>
    </svg>
);
...
export const DashBoard = () => (
    ...
    >
        <path
            fill="currentColor"
            d="M14.5 10.33h6.67A.83.83 0 0 0 22 9.5A7.5 7.5 0 0 0 14.5 2a.83.83 0 0 0-.83.83V9.5a.83.83 0 0 0 .83.83Zm.83-6.6a5.83 5.83 0 0 1 4.94 4.94h-4.94Z"
        ></path>
        <path
            fill="currentColor"
            d="M21.08 12h-8.15a.91.91 0 0 1-.91-.91V2.92A.92.92 0 0 0 11 2a10 10 0 1 0 11 11a.92.92 0 0 0-.92-1Z"
        ></path>
    </svg>
);
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 512 512">
        <defs>
            <linearGradient id="BG1" x1="100%" x2="50%" y1="9.946%" y2="50%">
                <stop offset="0%" stopColor="#103996"></stop>
                <stop offset="100%" stopColor="#2065D1"></stop>
            </linearGradient>
            <linearGradient id="BG2" x1="50%" x2="50%" y1="0%" y2="100%">
                <stop offset="0%" stopColor="#76B0F1"></stop>
                <stop offset="100%" stopColor="#2065D1"></stop>
            </linearGradient>
        ...
        <g fill="#2065D1" fillRule="evenodd" stroke="none" strokeWidth="1">
            <path
                fill="url(#BG1)"
