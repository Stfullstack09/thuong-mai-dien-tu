...
const WraperEmail = ({ setDataEmail, setContentHtml, setContentText, contentText, isLoadingSend, dataEmail, data }) => {
                ...
                {!_.isEmpty(dataEmail) ? (
                    <div>
                        <div className="my-2">
                            <p className="my-1">
                                <span>
                                    Email nhận thư : <b>{dataEmail.email}</b>
                                </span>
                            </p>
                            <p className="my-1">
                                <span>
                                    Tên khách hàng : <b>{`${dataEmail.firstName} ${dataEmail.lastName}`}</b>
                                </span>
                            </p>
                            <div className="my-2">
